  ...
  const projectArray = [
    {
      ...
      projectStacks: ['React', 'React Pro SideBar', 'MaterialUI', 'Formik', 'Yup', 'Nivo Charts'],
    ...
    },
    {
      ...
      projectStacks: ['React', 'Ruby on rails', 'css', 'javascript', 'Postgres', 'Jest', 'Rspec'],
    ...
    },
    {
      ...
      projectStacks: ['React', 'Ruby on rails', 'Postgres', 'Jest', 'Rspec'],
